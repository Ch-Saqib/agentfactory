...
class CurrentUser:
    ...
    Supports both attribute access (user.id) and dict-style access
    (user["sub"]) for backward compatibility with route handlers.
    """

    # Map dict-style keys to attribute names for backward-compatible access
    _KEY_MAP: dict[str, str] = {"sub": "id"}
    ...
    def __getitem__(self, key: str) -> Any:
        """Allow dict-style access (e.g. user['sub']) for backward compatibility."""
