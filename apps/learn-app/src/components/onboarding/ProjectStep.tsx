...
import type { ProfessionalContextSection, GoalsSection } from "@/lib/learner-profile-types";
...
export function ProjectStep({
    ...
    const project = professional.real_projects?.[0] || { project_name: "", description: "" };

    const handleProjectChange = (field: "project_name" | "description", value: string) => {
    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="bg-background/50 border border-border/50 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
                <div className="space-y-2">
                    <Label htmlFor="onboarding-project-name" className="text-sm font-semibold tracking-wide text-muted-foreground uppercase pl-1 opacity-90 block">
                        Project Name
                    </Label>
                    <Input
                ...
                <div className="space-y-3 pt-4 border-t border-border/50">
                    <div className="flex justify-between items-baseline mb-2">
                        <Label htmlFor="onboarding-project-desc" className="text-sm font-semibold tracking-wide text-muted-foreground uppercase pl-1 opacity-90 block">
                    ...
                    <Textarea
                        ...
                        onChange={(e) => handleProjectChange("description", e.target.value.substring(0, 300))}
                ...
                <div className="space-y-2 pt-6 border-t border-border/50">
                    <Label htmlFor="onboarding-career-goal" className="text-sm font-semibold tracking-wide text-muted-foreground uppercase pl-1 opacity-90 block">
                    ...
                    <Input
                        ...
                        onChange={(e) => onChangeGoals({ ...goals, career_goal: e.target.value || null })}
