...
| --------------------------- | ----------- | -------------------------------------------- |
| Digital FTE Architecture    | B1          | Explain Perception → Reasoning → Action      |
| Tiered Deliverable Planning | A2          | Identify which tier matches goals            |
| Specification Reading       | B1          | Navigate spec to find implementation details |
